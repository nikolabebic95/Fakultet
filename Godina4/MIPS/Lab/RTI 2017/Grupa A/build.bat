...
lnks -f startup.obj -f program.obj -s IVTRAM 0x0000 NOE -s DATARAM NOE -s DATA NOE -s BSS -s STACK NOE -s CODE 0xf800 -s DATAROM COPY DATA -s IVTROM COPY IVTRAM -s STARTUP 0xffff >linker_output.txt
