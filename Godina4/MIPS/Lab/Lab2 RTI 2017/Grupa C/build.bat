...
lnks -f startup.obj -f program.obj -s IVTRAM 0 NOE -s DATARAM NOE -s DATA NOE -s BSS -s STACK NOE -s CODE 0xf800 -s IVTROM COPY IVTRAM -s DATAROM COPY DATA -s STARTUP 0xffff >linker_output.txt
